export default (app) => {
  app.post(
    `/tenant/:tenantId/project/:projectId/project-management-plan`,
    require('./projectManagementPlanCreate').default,
  );
  app.put(
    `/tenant/:tenantId/project/:projectId/project-management-plan/:id`,
    require('./projectManagementPlanUpdate').default,
  );
  app.post(
    `/tenant/:tenantId/project/:projectId/project-management-plan/import`,
  ...
  app.get(
    `/tenant/:tenantId/project/:projectId/project-management-plan/autocomplete`,
